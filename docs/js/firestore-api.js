  ...
  try {
    ...
    snapshot.forEach(doc => {
      ...
      products.push({
        ...
        profit: data.profit || data.finalProfit || 0,
        finalProfit: data.finalProfit || data.profit || 0,
        profitRate: data.profitRate || '',
        shippingConfirmed: data.shippingConfirmed !== false,
        provisionalProfit: data.provisionalProfit || 0,
