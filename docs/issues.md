...
## TASK-001 | [CLOSED] 機能追加: やることリスト機能（タスク管理・通知・バッジ）

### 📌 基本情報
- [x] カテゴリ: 機能追加
- [x] 優先度: 中
- [x] **ステータス: クローズ（2026-03-06）** — 優先度見直し
...
## MASTER-002 | [CLOSED] 機能追加: 汎用マスタ管理エンジン実装（案B+案Aハイブリッド）

### 📌 基本情報
- [x] カテゴリ: 機能追加 / マスタ管理
- [x] 優先度: 高
- [x] **ステータス: クローズ（2026-03-06）** — 運用方針変更
...
## PLAT-001 | [保持] 機能追加: マルチプラットフォーム（マルチテナント）対応

### 📌 基本情報
- [ ] カテゴリ: 機能追加 / アーキテクチャ
- [ ] 優先度: 高
- [ ] **ステータス: 保持（2026-03-06）** — 中長期ロードマップ、セッション読み込み対象外
...
## MAP-001 | [保持] 設計: マルチプラットフォームカテゴリマッピング

### 📌 基本情報
- [ ] カテゴリ: 設計 / アーキテクチャ
- [ ] 優先度: 高
- [ ] **ステータス: 保持（2026-03-06）** — PLAT-001依存、中長期ロードマップ
...
## TEST-001 | [CLOSED] テスト: Firestore移行後の全メニュー機能検証

### 📌 基本情報
- [x] カテゴリ: テスト・検証
- [x] 優先度: 🔴 最高
- [x] **ステータス: クローズ（2026-03-06）** — 日常運用で検証済み
...
## CONTRACT-001 | [保持] 機能追加: 電子契約・電子署名機能（業務委託契約書）

### 📌 基本情報
- [ ] カテゴリ: 機能追加 / 契約管理
- [ ] 優先度: 中
- [ ] **ステータス: 保持（2026-03-06）** — 大規模・法務要件あり、着手時期未定
