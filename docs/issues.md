...
## UI-015 | UI改善: チャットメニュー追加（トップメニュー・サイドメニュー）

### 📌 基本情報
- [ ] カテゴリ: UI改善
- [ ] 優先度: 低
- [ ] 影響範囲: PWA - トップメニュー、サイドメニュー
- [ ] 発見日: 2025-11-15
...
- [ ] menu_home.html: チャット項目を「入出庫履歴」と「マスタ管理」の間に追加
- [ ] navigateToPage('chat') 関数呼び出し実装
- [ ] docs/index.html: サイドメニューにチャット項目追加
- [ ] drawer-chat アイテムにアクティブ状態反映
